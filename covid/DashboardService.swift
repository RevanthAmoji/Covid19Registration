...
//            print("Upload Personalized KPI Response \(response)")
            ...
            case .success:
                ...
                do {
                    let responseDecoder = try JSONDecoder().decode(Bool.self, from: response.data!)
                    // print("getAppointmentData Dashboard Response \(String(describing: responseDecoder.data?.count))")
                    completion(ServiceResult.success(value: responseDecoder))
                }
                catch let e {
...
//            print("Upload Personalized KPI Response \(response)")
    ...
    func getVerifiedData(url:String,completion: @escaping (_ : ServiceResult<Any>) -> Void) {
...
//            print("Upload Personalized KPI Response \(response)")
            ...
            case .success:
               ...
               // do {
                   ...
                   // let responseDecoder = try JSONDecoder().decode(Any, from: response.data!)
                    // print("getAppointmentData Dashboard Response \(String(describing: responseDecoder.data?.count))")
                    completion(ServiceResult.success(value: dataString as Any))
//                }
//                catch let e {
//                    print("decoder error \(e)")
//                    completion(ServiceResult.failure(error: e))
...
//            print("Upload Personalized KPI Response \(response)")
    ...
    func getEmailVerification(url:String,strData:String,completion: @escaping (_ : ServiceResult<AccountDetails>) -> Void) {
    ...
    func getLogin(url:String,completion: @escaping (_ : ServiceResult<LoginModel>) -> Void) {
        ...
        AF.request(request).responseJSON { response in
            ...
            case .success:
                ...
                do {
                    let responseDecoder = try JSONDecoder().decode(LoginModel.self, from: response.data!)
                    // print("getAppointmentData Dashboard Response \(String(describing: responseDecoder.data?.count))")
                    completion(ServiceResult.success(value: responseDecoder))
                }
                catch let e {
